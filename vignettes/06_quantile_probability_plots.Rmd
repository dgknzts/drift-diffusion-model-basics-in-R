...
qpp_multi_cond_base_params <- list(
  a = 0.7,
  mean_z = 0.35, # Unbiased
  s = 0.2,      # Lower s for clearer v effect
  mean_ter = 0.2,
  sv = 0.2,     # Moderate sv
  sz = 0.1,     # Moderate sz
...
n_trials_qpp_multi <- 300 # Good number of trials per condition
...
data_v_high_multi <- do.call(simulate_diffusion_experiment_variable,
                        c(list(n_trials = n_trials_qpp_multi, mean_v = 0.25), qpp_multi_cond_base_params))
...
multi_condition_qpp_plot <- plot_qpp(
  ...
  rt_lim = c(0.2, 2.0),     # Set a common RT limit for comparison, adjust as needed
  show_median_line = TRUE,
  median_line_color = "black",
