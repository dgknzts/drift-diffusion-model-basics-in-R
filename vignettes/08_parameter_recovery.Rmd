...
true_parameters <- list(
  ...
  s        = 0.1,     # Within-trial noise
  mean_ter = 0.12,    # Non-decision time
  sv       = 0.08,    # Drift rate variability
...
recovery_results <- run_ddm_optimization_multi_start(
  n_starts = 5,  # Number of different starting points
  ...
  n_sim_per_eval = 1500,  # Trials simulated per optimization step
